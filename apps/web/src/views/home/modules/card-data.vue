...
import { fetchDashboardCards } from "@/service/api";
...
const metrics = ref<Api.Dashboard.Cards>(fallback);
...
const cardData = computed<CardData[]>(() => [
  {
    ...
    value: metrics.value.visitCount,
    unit: "",
    color: {
      start: "#ec4786",
      end: "#b955a4",
  ...
  },
  {
    ...
    value: metrics.value.downloadCount,
    unit: "",
    color: {
      start: "#56cdf3",
      end: "#719de3",
